              ...
              {navLinks.map((item) => {
                ...
                return (
                  <Link
                    key={item.to}
                    to={item.to}
                    className="relative group px-3 py-1.5 text-sm font-medium text-slate-200 hover:text-white transition"
                  >
                    {active && (
                      <motion.span
                    ...
                    <span className="pointer-events-none absolute left-1/2 top-full h-px w-0 -translate-x-1/2 bg-gradient-to-r from-indigo-400 via-violet-500 to-rose-400 transition-all duration-300 group-hover:w-8"></span>
                  </Link>
                )
              })}
            </div>
                      ...
                      {navLinks.map((item, idx) => (
                        ...
                        >
                          <Link
                            ...
                            className="block rounded-xl px-4 py-3 text-base font-medium text-slate-100 hover:text-white hover:bg-white/10 transition"
                          >
                            {item.label}
                          </Link>
                        </motion.div>
